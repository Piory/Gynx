...
part of '../../../../../application/usecase/params/sign_in_param.dart';
...
class _$SignInParamImpl implements _SignInParam {
  const _$SignInParamImpl({required this.email, required this.password});
...
abstract class _SignInParam implements SignInParam {
  const factory _SignInParam(
      ...
      required final String password}) = _$SignInParamImpl;
