...
void main() {
  ...
  group('#findByUserIdAndSincePostId', () {
    group('正常系', () {
      test('指定した userId に紐づくデータかつ指定した postId より大きい値かつ指定した件数のデータが取得できること',
          () async {
      ...
      test(
          '指定した userId に紐づくデータかつ指定した postId より大きい値かつ指定した件数に満たない場合は、それ以降のデータが全て取得できること',
          () async {
        final actual = await vPostRepository.findByUserIdAndSincePostId(
          vPost1.userId,
          2,
  ...
  group('#findByUserIdMaxPostId', () {
    group('正常系', () {
      test('指定した userId に紐づくデータかつ指定した postId より小さい値かつ指定した件数のデータが取得できること',
          () async {
      ...
      test(
          '指定した userId に紐づくデータかつ指定した postId より小さい値かつ指定した件数に満たない場合は、それ以前のデータが全て取得できること',
          () async {
        final actual = await vPostRepository.findByUserIdAndMaxPostId(
          vPost1.userId,
          4,
