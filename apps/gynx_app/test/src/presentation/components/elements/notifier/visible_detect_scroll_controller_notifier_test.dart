...
class _VisibleDetectScrollControllerNotifierTest extends StatefulWidget {
  ...
  final NotificationListenerCallback<ScrollControllerNotification>
      onNotification;

  @override
  State<_VisibleDetectScrollControllerNotifierTest> createState() =>
      _VisibleDetectScrollControllerNotifierTestState();
}
...
void main() {
  ...
  Future<void> pumpWidget({
    ...
    required NotificationListenerCallback<ScrollControllerNotification>
        onNotification,
  }) async {
