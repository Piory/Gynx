...
mixin class TimelineNotifierMixin {
  Ref<AsyncValue<TimelineState>> get timelineNotifierRef => throw UnimplementedError();

  AsyncValue<TimelineState> get timelineState => throw UnimplementedError();

  set timelineState(AsyncValue<TimelineState> value) => throw UnimplementedError();

  Future<VPostList> fetchBySincePostId(int? sincePostId) => throw UnimplementedError();

  Future<VPostList> fetchByMaxPostId(int? maxPostId) => throw UnimplementedError();
  ...
  int getByIndex(int index) => timelineState.requireValue.postIdList.getByIndex(index);
  ...
  Future<void> fetchNext() async {
    ...
    timelineState = await AsyncValue.guard(() async {
      ...
      timelineNotifierRef.read(postMapNotifierProvider.notifier).putByList(vPostList);
