...
class TimelineNotifier extends _$TimelineNotifier with TimelineNotifierMixin {
  ...
  @override
  Future<VPostList> fetchBySincePostId(int? sincePostId) => GetIt.I<FetchPostUseCase>().execute(
        sincePostId: maxPostId,
      );

  @override
  Future<VPostList> fetchByMaxPostId(int? maxPostId) => GetIt.I<FetchPostUseCase>().execute(
        maxPostId: minPostId,
      );
}
