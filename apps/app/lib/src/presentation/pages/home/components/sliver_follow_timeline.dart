...
import 'package:app/src/presentation/components/parts/posts/sliver_post_list_loading.dart';
...
class SliverFollowTimeline extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SliverFollowTimeline> createState() => _SliverFollowTimelineState();
}
