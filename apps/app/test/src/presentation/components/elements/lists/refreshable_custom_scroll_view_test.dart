import 'package:app/src/presentation/components/elements/lists/refreshable_custom_scroll_view.dart';
...
void main() {
  ...
  group('正常系', () {
    ...
    testWidgets('backgroundColor が指定されていない場合、Colors.transparent が使用されていること', (tester) async {
      await pumpWidget(
        tester: tester,
