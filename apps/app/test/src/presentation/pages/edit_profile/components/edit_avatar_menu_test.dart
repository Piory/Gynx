...
import 'package:app/src/presentation/pages/edit_profile/components/edit_avatar_menu.dart';
...
void main() {
  ...
  group('初期表示時', () {
    group('正常系', () {
      testWidgets('visibleDelete が true の場合、「${l10nJa.deleteImage}」が表示されること', (tester) async {
        await pumpWidget(
          tester: tester,
          visibleDelete: true,
      ...
      testWidgets('visibleDelete が false の場合、「${l10nJa.deleteImage}」が表示されないこと', (tester) async {
        await pumpWidget(
          tester: tester,
          visibleDelete: false,
          onChanged: (_) => fail('unexpected onChanged'),
