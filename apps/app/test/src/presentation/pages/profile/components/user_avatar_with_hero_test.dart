...
void main() {
  ...
  group('UserAvatarWithHero', () {
    ...
    group('正常系', () {
      testWidgets('avatarUrl が取得されるまでは、UserAvatar の isLoading に true が指定され、タップしても PageNavigator#push が呼ばれないこと', (tester) async {
        await pumpWidget(
          tester: tester,
          suiteUser: suiteUser,
        );
      ...
      testWidgets(
        ...
        (tester) async {
          ...
          final userAvatarAfterPump = tester.widget<UserAvatar>(find.byType(UserAvatar));
