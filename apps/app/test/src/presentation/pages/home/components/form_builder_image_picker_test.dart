        ...
        group(
          ...
          () {
            testWidgets('動画選択', (tester) async {
              ...
              when(mockFlutterVideoInfo.getVideoInfo('video-path')).thenAnswer((_) async => mockVideoData);
            ...
            testWidgets(
              ...
              (tester) async {
                ...
                when(mockFlutterVideoInfo.getVideoInfo('video-path')).thenAnswer((_) async => null);
                await pumpWidget(
                  tester: tester,
                  onChanged: (_) => fail('unexpected call'),
                );
